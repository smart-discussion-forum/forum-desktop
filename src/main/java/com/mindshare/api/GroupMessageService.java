...
public class GroupMessageService {
    ...
    public JsonNode sendMessage(int groupId, String message) throws IOException {
        String requestBody = objectMapper.writeValueAsString(new MessageRequest(groupId, message));
        try (CloseableHttpClient client = HttpClients.createDefault()) {
    ...
    private static class MessageRequest {
        ...
        private MessageRequest(int groupId, String message) {
